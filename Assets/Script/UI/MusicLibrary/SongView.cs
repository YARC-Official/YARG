	...
	public class SongView : MonoBehaviour {
		...
		public void UpdateView() {
			...
			if (selected) {
				...
				_secondaryText.color = new Color(0.192f, 0.894f, 0.945f, 1.0f);
				_secondaryText.text = $"<font-weight=500>{viewType.SecondaryText}</font-weight>";
			} else {
				_primaryText.color = new Color(0.192f, 0.894f, 0.945f, 1.0f);
				_primaryText.text = viewType.PrimaryText;

				_secondaryText.color = new Color(0.192f, 0.894f, 0.945f, 0.3f);
				_secondaryText.text = viewType.SecondaryText;
			}
