...
namespace YARG.Data {
	public static class SongSources {
		public static readonly Dictionary<string, string> DEFAULT_SOURCES = new() {
			...
			{ "ham1", "Dance Central 1" },
			{ "ham1_dlc", "Dance Central 1 DLC" },
			{ "ham2", "Dance Central 2" },
			{ "ham2_dlc", "Dance Central 2 DLC" },
			{ "ham3", "Dance Central 3" },
			{ "ham3_dlc", "Dance Central 3 DLC" },
			{ "rb1", "Rock Band 1" },
			{ "rb2", "Rock Band 2" },
			{ "rb3", "Rock Band 3" },
			{ "rb4", "Rock Band 4" },
			...
			{ "rs", "Rocksmith" },
			{ "rsdlc", "Rocksmith DLC" },
			{ "rs2014", "Rocksmith 2014" },
			{ "rs2014dlc", "Rocksmith 2014 DLC" },
			{ "rsp", "Rocksmith+" },
			{ "scorespy", "ScoreSpy" },
			{ "s_hero", "S Hero" },
