...
namespace YARG.Networking.Bookmarks
{
    ...
    public sealed class LobbyBookmarkStore
    {
        ...
        public void RecordConnection(string address, int port, string displayName, string password)
        {
            ...
            {
                existingRecent.displayName = string.IsNullOrWhiteSpace(displayName) ? existingRecent.displayName : displayName.Trim();
            ...
            if (favorite != null)
            {
                ...
                favorite.displayName = string.IsNullOrWhiteSpace(displayName) ? favorite.displayName : displayName.Trim();
        ...
        {
            public List<LobbyBookmark> favorites = new();
            public List<LobbyBookmark> recents = new();
        }
    }
}
