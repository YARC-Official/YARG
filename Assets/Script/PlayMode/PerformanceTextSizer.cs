...
namespace YARG.PlayMode {
	public class PerformanceTextSizer {
		...
		public PerformanceTextSizer(float fontSize, float animationLength, bool representsPeakSize = false) {
			_fontSize = fontSize;
		...
		public float PerformanceTextFontSize() {
			...
			// Size appropriately
			return relativeSize * _fontSize * (_representsPeakSize ? 1.0f : 1.11111f);
		}
	}
}