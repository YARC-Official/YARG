...
namespace YARG.PlayMode
{
    public class TrackAnimations : MonoBehaviour
    {
        ...
        */
        ...
        {
            var spLights = Instantiate(commonTrack.starPowerLightIndicators, spLightsStartPos,
                commonTrack.starPowerLightIndicators.transform.rotation);
        ...
        public void StarpowerLightsAnim()
        {
            if (!spLightsPlayed)
            {
                GameObject spLights = Instantiate(commonTrack.starPowerLightIndicators, spLightsStartPos,
                    commonTrack.starPowerLightIndicators.transform.rotation);
        ...
        public void StarpowerParticleAnim()
        {
            ...
            {
                commonTrack.starPowerParticles.transform.position = Vector3.Lerp(spParticleStartPos,
                    spParticleStartPos + spParticleEndPos, spParticleAnimCurve.Evaluate(percentageComplete));
                commonTrack.starPowerParticles2.transform.position = Vector3.Lerp(spParticle2StartPos,
                    spParticle2StartPos + spParticle2EndPos, spParticleAnimCurve.Evaluate(percentageComplete));
            }
        }
        ...
        public void StarpowerTrackAnim()
        {
            ...
            if (!spShakeDepressed && !spShakeAscended)
            {
                ...
                commonTrack.TrackCamera.transform.position =
                    Vector3.Lerp(trackStartPos, trackStartPos + trackEndPos, percentageComplete);
            ...
            if (spShakeDepressed && !spShakeAscended)
            {
                ...
                commonTrack.TrackCamera.transform.position =
                    Vector3.Lerp(trackStartPos + trackEndPos, trackStartPos, percentageComplete);
        ...
        public void StarpowerTrackAnimReset()
        {
            ...
            {
                trackStartPos =
                    commonTrack.TrackCamera.transform
                        .position; // This gets the initial track camera position, Kick shake animation also uses this.
        ...
        public void KickShakeCameraAnim()
        {
            ...
            if (executeKickShake)
            {
                if (!kickShakeGone && !kickShakeReturned)
                {
                    ...
                    commonTrack.TrackCamera.transform.position =
                        initialCameraPos +
                        trackEndPosKick; // a Nan issue so I changed to lerp to instant position assign. Should present no issues since "MiddleDuration" lasted less than a frame. - Mia
                ...
                if (kickShakeGone && !kickShakeReturned)
                {
                    ...
                    commonTrack.TrackCamera.transform.position = Vector3.Lerp(initialCameraPos + trackEndPosKick,
                        initialCameraPos, percentageComplete);
