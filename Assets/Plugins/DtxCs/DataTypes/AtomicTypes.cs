...
namespace DtxCS.DataTypes
{
    ...
    public class DataVariable : DataNode
    {
        ...
        {
            DataVariable ret;
            if (!vars.TryGetValue(name, out ret)) vars.Add(name, ret = new DataVariable(name, new DataAtom(0)));
            return ret;
        }
    ...
    public class DataSymbol : DataNode
    {
        ...
        {
            DataSymbol ret;
            if (!symbols.TryGetValue(value, out ret)) symbols.Add(value, ret = new DataSymbol(value));
            return ret;
        }
